  ...
  const features = [
    {
      ...
      description:
        "Once you're setup in our system, login and reserve your ski in under 3 minutes!",
      iconAlt: "Calendar",
    },
    {
      icon: jetSkiIcon,
      ...
      description:
        "Choose from one of our 15 From 130hp, 300hp. Suited for beginners and experts.",
      iconAlt: "Jet Ski",
    },
    {
      icon: crownIcon,
      title: ["Wide range of", "Ski's Available"],
      description:
        "Once you're in our system, maintain your access anytime with a once off weekly payment.",
      iconAlt: "VIP Crown",
    },
  ];
    ...
    <Container>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center gap-10 md:gap-6 lg:gap-8">
        ...
        <Link href={"/membership-plans"}>
          <div className="bg-[#00AEEF]  rounded-xl p-6 text-white relative overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:scale-105">
            <div className="flex items-start gap-3 mb-4">
              <div className="w-10 h-10 flex-shrink-0 mt-1">
                <Image
                  ...
                  width={40}
                  height={40}
                  className="w-full h-full object-contain filter brightness-0 transition-transform duration-300 group-hover:rotate-12"
                />
              </div>
            ...
            <p className="text-gray-200 text-sm leading-relaxed">
              Signup today JetXClub online and get started with your anytime Ski
              Access!
            </p>
          </div>
        </Link>
